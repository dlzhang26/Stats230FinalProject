...
msummary(ModTwoPred)
```
**Table 3. Two Predictor Model With Pre-Injury Play Time and Amount of Games Missed** The MLR model is significant overall, F(3,164) = 60, p-value <0.001. Within the model, Pre-Injury Play Time (p-value <0.001 for the t-test) and Missing two or more games (p-value = 0.015 for the t-test) are significant predictors. 
