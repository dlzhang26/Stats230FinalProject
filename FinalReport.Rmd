...
```
**Fig. 6. Pre-Injury Play Time Without the Outlier.** Removing the outlier, the residuals and QQ plot improved. There is a strong, positive, linear relationship between Post-Injury Play Time and Pre-Injury Play Time (r = 0.674). In other words, the more pre-injury play time a player had, the more post-injury play time a player had.  
