...
```{r}
finalData1 <- select(finalData, "PostIPT" , "amtGamesMissed", "PreIPT", "WeekOfInjury",  "CurrentAge", "AgeFirstConcussion", "PreseasonInjury", "Position", "Season")
ggpairs(finalData1)
...
```
```{r}
gf_point(AgeFirstConcussion~CurrentAge, data = finalData1)
