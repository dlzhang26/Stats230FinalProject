...
fm.full <- lm(PostIPT ~ PreIPT + WeekOfInjury + AgeAtConcussion + Position + amtGamesMissed , data = finalData1)
anova(fm.full)
...
```{r}
## make new data file with removed outliers. 
mod2a <- lm(PostIPT ~ PreIPT + amtGamesMissed, data = finalDataAug, subset =  finalDataAug$.resid > -50 )## need to describe who they were and why you are removing -- this removed 2
...
mod2 <- lm(PostIPT ~ PreIPT + amtGamesMissed, data = finalDataAug, subset =  abs(finalDataAug$.resid) < 40 )## need to describe who they were and why you are removing -- this removed 6. might be too many
anova(mod2)
msummary(mod2)
mplot(mod2, which = 1 )
mplot(mod2, which = 2 )
...
```{r}
#fmfullll <- lm(PostIPT ~ PreIPT + Position + WeekOfInjury + AgeAtConcussio, data = finalDataAug, subset =  abs(finalDataAug$.resid) < 50 )

#anova(fmfullll)
#msummary(fmfullll)
#mplot(fmfullll, which = 1 )
#mplot(fmfullll, which = 2 )
```
