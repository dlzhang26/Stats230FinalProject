...
gf_bar(~ PreseasonInjury, data = studydata, col = c("red", "green"))

barplot(table(studydata$Position), main="Positions",ylab="Freqency", cex.axis = 0.8, cex.names = 0.6, las=2)

gf_bar(~Season, data = studydata)

gf_histogram(~amtGamesMissed, data = studydata)
#gf_bar(~AveragePreInjuryPlayTime, data = studydata)
