...
The population of this dataset is NFL players during the seasons of 2012 to 2014 that obtained a concussion. Our sample will consist of a random sample of NFL players in a dataset filtered for just those who obtained a concussion in 2012-2014. 
...
alldata <- filter(alldata, Reported.Injury.Type == "Concussion") ## 
