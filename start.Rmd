...
```{r}
#getwd() in console to find the directory where the csv file is stored on your conputer
setwd("C:/Users/donna/OneDrive/Documents/STAT230/Stats230FinalProject/")
alldata <- read.csv("/ConcussionInjuries2012-2014.csv") 
glimpse(alldata)
```

```{r}

read_csv('Concussion_Injuries_2012_2014', show_col_types = FALSE)
```
