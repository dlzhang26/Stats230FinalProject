...
## Proposal    
```{r}
alldata <- read.csv("/home/class27/khuang27/Stat_230_Final_Project!")
glimse(alldata)
```
...
alldata <- read.csv("/home/class27/khuang27/Stat_230_Final_Project!/ConcussionInjuries2012-2014.csv")
...
gf_histogram(~amtTimeInjured, data = studydata) ## binary data idk what the data means
