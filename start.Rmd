...
m1 <- gf_histogram(~TimeOfInjury, data = studydata, include=FALSE)
...
grid.arrange(m1, m2, m3, ncol=3, top = "Titile") 
grid.arrange(m4, m5, ncol = 1, top = "Title")
...
Sample code to make plots together.  These are not your variables but you can see how it's done.```{r, warning = FALSE, echo = FALSE
